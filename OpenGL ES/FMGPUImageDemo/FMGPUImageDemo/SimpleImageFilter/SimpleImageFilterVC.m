...
@interface SimpleImageFilterVC ()

@end

@implementation SimpleImageFilterVC
...
- (void)loadView
{
    ...
    imageSlider = [[UISlider alloc] initWithFrame:CGRectMake(25.0, mainScreenFrame.size.height - 70.0, mainScreenFrame.size.width - 50.0, 40.0)];
